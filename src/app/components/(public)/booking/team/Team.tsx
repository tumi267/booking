...
import type {BookingData,TeamMember,} from '@/app/types/booking'
...
export default function Team({currentStep,step,bookingdata,team,onSelectMember,}: Props) {
    ...
    <div className="flex flex-col items-center mt-6 mb-6">
      ...
      >
        {availableTeam.map((member) => {
          const isSelected =
            bookingdata.providerId === member.id
